...
namespace PEF.Areas.Control.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index(string? culture)
        {
            ...
            //ViewBag.PageTitle = _localizer["About Title"];
            ...
            if (!String.IsNullOrEmpty(HttpContext.Session.GetString("type")) && HttpContext.Session.GetString("type") == "Employer")
            {
                ...
                ViewBag.JobsCount = _context.Jobs.Where(a => a.Deleted == false && a.EmployerId == EmployerId).Count();
                ViewBag.AppsCount = _context.JobsApplications.Where(a => a.Deleted == false && a.Job.EmployerId == EmployerId).Count();
                ViewBag.ProjectsCount = _context.ProjectsEmployers.Where(a => a.EmployerId == EmployerId && a.Project.Deleted==false && a.Project.EndDate > DateTime.Now.AddDays(-1)).Count();
                ViewBag.EmployedCount = _context.JobsApplications.Where(a => a.Deleted == false && a.Job.EmployerId == EmployerId && a.Status == 5).Count();
                
                ViewBag.LatestJobs = _context.Jobs.Where(a => a.Deleted == false && a.EmployerId == EmployerId && a.ExpireDate >= DateTime.Now.AddDays(-1))
                    .Include(a => a.JobsApplications)
                    .OrderByDescending(a => a.Id)
                    .ToList();
                    
                ViewBag.ExpiredJobs = _context.Jobs.Where(a => a.Deleted == false && a.EmployerId==EmployerId && a.ExpireDate < DateTime.Now)
                    .Include(a => a.JobsApplications)
                    .OrderByDescending(a => a.Id)
                    .ToList();
            ...
            else
            {
                ...
                ViewBag.MembersCount = _context.Members.Where(a => a.Deleted == false).Count();
                ViewBag.JobsCount = _context.Jobs.Where(a => a.Deleted == false && a.Employer.Deleted==false ).Count();
                ViewBag.JobsAppsCount = _context.JobsApplications.Where(a => a.Deleted == false && a.Job.Deleted == false).Count();
                ViewBag.DonorsCounts = _context.Donors.Where(a => a.Deleted == false).Count();
                ViewBag.ProjectsCount = _context.Projects.Where(a => a.Deleted == false
                    && ((IsSuper == true || UserId == null) || (a.UsersProjects != null && a.UsersProjects.Any(b => b.UserId == UserId)))
                    ).Count();
                ViewBag.EmployersCount = _context.Employers.Where(a => a.Deleted == false).Count();
